...
![](images/res/vipsocio){.absolute top=400 right=815 height="39%"}
...
* [**Test mode on Year 22 data:**]{.fragment .rgb} Validate the model's performance on the Year 22 data to assess its generalizability and predictive power.
...
- Just like a natural neural network, an artificial neural network the connections betweeen the nodes (weights) become stronger or weaker based on the training (or learning). 
