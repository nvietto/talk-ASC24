...
![](images/tidymodels.png){.absolute top=200 right=690 width="50%"}
:::
...
![](images/res/socroc.png){.absolute top=110 right=600 height="70%"}
...
![](images/res/psychroc.png){.absolute top=110 right=600 height="70%"}
...
![](images/res/generoc.png){.absolute top=110 right=600 height="70%"}
...
![](images/res/allrocplot.png){.absolute top=110 right=600 height="70%"}
...
![](images/res/allroc.png){.absolute top=140 right=550 height="55%"}

![](images/res/Acc.png){.absolute top=140 right=-170 height="55%"}
