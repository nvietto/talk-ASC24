...
![](images/res/socroc.png){.absolute top=140 right=600 height="55%"}
![](images/res/vipsocial.png){.absolute top=200 right=0 height="40%"}



## Preliminary Results (Psychological)

![](images/res/psychroc.png){.absolute top=140 right=600 height="55%"}


![](images/res/vippsych.png){.absolute top=200 right=0 height="40%"}


## Preliminary Results (Genetic)

![](images/res/generoc.png){.absolute top=140 right=600 height="55%"}


![](images/res/genevip.png){.absolute top=200 right=0 height="40%"}

## Preliminary Results (Biopsychosocial)



![](images/res/allrocplot.png){.absolute top=140 right=600 height="55%"}

![](images/res/allvip.png){.absolute top=190 right=50 height="45%"}
...
![](images/res/allroc.png){.absolute top=200 right=750 height="38%"}

![](images/res/Acc.png){.absolute top=200 right=300 height="38%"}


![](images/res/bre.png){.absolute top=200 right=-140 height="38%"}
...
* [**Treat delinquency as a continuous outcome**]{.fragment .rgb} rather than a classification model.

* [**Manually fix the GxE interactions**]{.fragment .rgb} using domain knowledge rather than allowing model to determine the interaction.
...
![](images/res/aucover.png){.absolute top=200 right=750 height="37%"}

![](images/res/accover.png){.absolute top=200 right=300 height="37%"}

![](images/res/Overbr.png){.absolute top=200 right=-140 height="37%"}
