...
![](images/tidymodels.png){.absolute top=200 right=650 width="50%"}
:::
...
![](images/res/allroc.png){.absolute top=140 right=520 height="55%"}

![](images/res/Acc.png){.absolute top=140 right=-160 height="55%"}
